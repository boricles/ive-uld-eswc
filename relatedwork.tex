...
Moreover, there are some existing efforts such as Zhang et al.\cite{ZhangCQ07} for summarizing ontologies based on RDF sentence graphs, and Li et al. \cite{LiM10} for user-driven ontology summarization.
